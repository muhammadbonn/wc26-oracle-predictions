...
if not st.session_state.logged_in:
    ...
    with tab1:
        ...
        # Time synchronization for Egypt Time
        current_egypt_time = datetime.now(timezone.utc) + timedelta(hours=3)
                ...
                for date_str, date_group in round_group.groupby('date_group', sort=False):
                    ...
                    for _, row in date_group.iterrows():
                        ...
                        if current_egypt_time < m_time:
                            # Displaying time only without repetitive labels
    ...
    with tab2:
        ...
        # Leaderboard processing logic remains as discussed
        pass
